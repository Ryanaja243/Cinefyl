...
function AuthForm({ mode }) {
    ...
    const { setUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$cinefyl$2d$shell$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    const [callbackUrl, setCallbackUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('/');
    ...
    async function submit(event) {
        ...
        if (register && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cinefyl$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValidUsername"])(form.username)) return setError('Username must be 3-15 alphanumeric characters or underscores');
        if (!form.email || !form.password) return setError(register ? 'All fields are required' : 'Email and password are required fields');
        if (register && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cinefyl$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValidEmail"])(form.email)) return setError('Invalid email format');
        if (register && form.password.length < 6) return setError('Password must be at least 6 characters');
        setBusy(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cinefyl$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"])(`/api/auth/${register ? 'register' : 'login'}`, {
                method: 'POST',
            ...
            setUser((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cinefyl$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sanitizeUser"])(result));
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(register ? 'Welcome to Cinefyl' : 'Welcome back');
    ...
    const field = (key, label, type = 'text', placeholder = '')=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
...
//# sourceMappingURL=components_auth-form_tsx_18t2w47._.js.map