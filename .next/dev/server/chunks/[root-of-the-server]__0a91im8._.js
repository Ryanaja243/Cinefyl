...
async function GET(req) {
    try {
        ...
        if (!q || q === "__default__") {
            const lookups = await Promise.all(DEFAULT_POPULAR_MOVIES.map(async (title)=>{
                try {
            ...
            const Search = lookups.filter((m)=>m !== null).map((m)=>({
                    Title: m.Title,
                    Year: m.Year,
                    imdbID: m.imdbID,
                    Poster: m.Poster,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0a91im8._.js.map