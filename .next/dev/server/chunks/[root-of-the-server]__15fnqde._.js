...
"[project]/app/api/watchlist/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Watchlist$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/Watchlist.ts [app-route] (ecmascript)");
    ...
    try {
        ...
        if (!userId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "userId parameter or active session is required"
            }, {
                status: 400
            });
        }
        ...
        const watchlistItems = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Watchlist$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            userId
        }).sort({
            createdAt: -1
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(watchlistItems);
    } catch (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function POST(req) {
    try {
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Watchlist$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            userId,
            imdbID
        });
        if (existing) {
        ...
        const newItem = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Watchlist$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            userId: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["default"].Types.ObjectId(userId),
            imdbID,
            title,
            year,
            poster
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: "Failed to save watchlist item",
            error: error.message
        }, {
            status: 500
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__15fnqde._.js.map